...
export const ProfessorCharacter: React.FC<ProfessorCharacterProps> = ({ onClick }) => {
  return (
    ...
    >
      ...
      <div className="relative w-16 h-16 bg-[#0a0a0c] border border-blue-500/30 rounded-full flex items-center justify-center shadow-2xl overflow-hidden group-hover:scale-110 transition-transform duration-300">
