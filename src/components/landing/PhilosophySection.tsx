...
const BLOCKS = [
  ...
  },
  {
    ...
    body: "Designed for the student sitting up with an exam coming up. This isn't just another AI tool; it's a smart advantage for the ambitious who refuse to leave their grades to chance.",
  },
];
