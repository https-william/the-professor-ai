    ...
    <section id="features" className="w-full py-20 px-4 md:px-8 lg:px-12 bg-transparent max-w-6xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {CARDS.map((card, i) => (
          <div 
            key={i} 
            className="p-8 rounded-[28px] bg-[var(--bg-2)] border border-[var(--border)] hover:border-blue-500/20 hover-lift-md transition-all duration-300 flex flex-col gap-5"
          >
            {/* Icon Wrapper */}
