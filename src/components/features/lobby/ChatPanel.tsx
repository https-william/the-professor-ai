        ...
        <div className="flex flex-col h-full bg-[#0A0A0F] rounded-2xl border border-white/5 overflow-hidden">
            ...
            <div className="flex items-center justify-between p-4 border-b border-white/5 bg-white/[0.02]">
                <div className="flex items-center gap-2">
                    <MessageSquare size={18} strokeWidth={1.5} className="text-[#10B981]" />
                            ...
                            >
                                <div className={`max-w-[80%] ${isOwn ? 'order-2' : 'order-1'}`}>
                                    ...
                                    <div className={`px-4 py-2.5 rounded-2xl ${
                                        isOwn
                                            ? 'bg-[#10B981]/20 text-white rounded-br-md'
            ...
            <div className="p-4 border-t border-white/5 shrink-0">
                <div className="flex gap-2">
                    <input
                        ...
                        maxLength={500}
                        className="flex-1 px-4 py-3 rounded-xl bg-black/40 border border-white/10 text-sm text-white placeholder:text-white/20 outline-none focus:border-[#10B981]/50 transition-all"
                    />
                    <button
                        onClick={handleSend}
                        disabled={!newMessage.trim() || isSending}
                        className="px-4 py-3 rounded-xl bg-[#10B981] text-white disabled:opacity-30 hover:bg-[#10B981]/90 transition-all"
                    >
