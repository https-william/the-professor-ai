...
export async function GET(req: NextRequest) {
    try {
        ...
        if (code) {
            ...
            // If the join fails due to relationship issues, fallback to manual profile fetch
            ...
            if (roomError || !room) {
                return NextResponse.json({ error: "Room not found or scholarly connection unstable" }, { status: 404 });
            }
