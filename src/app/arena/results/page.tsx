    ...
    if (loading) {
        return (
            <div className="min-h-screen bg-[var(--background)] flex flex-col items-center justify-center text-[var(--foreground)]">
                ...
                <p className="text-xs font-bold uppercase tracking-widest text-[var(--foreground-muted)]">Calculating Results...</p>
            </div>
        );
    }
    ...
    if (error || !duel) {
        return (
            <div className="min-h-screen bg-[var(--background)] flex flex-col items-center justify-center text-[var(--foreground)] p-4">
                <p className="text-sm font-bold text-red-500 mb-4 uppercase tracking-widest">{error || "Results not found"}</p>
