  ...
  return (
    <html lang="en" className={`${outfit.variable} ${sourceSerif.variable} ${jetbrainsMono.variable} w-full min-h-screen`} data-scroll-behavior="smooth" suppressHydrationWarning>
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "@type": "Organization",
              "name": "The Professor",
              "url": "https://www.theprofessor.xyz",
              "logo": "https://www.theprofessor.xyz/icon.svg",
            }),
          }}
        />
      </head>
      <body className="font-sans antialiased w-full min-h-screen m-0 p-0 flex flex-col" suppressHydrationWarning>
        <a 
          href="#main-content" 
          className="sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 focus:z-[9999] focus:px-4 focus:py-2 focus:bg-white focus:text-black focus:rounded-md focus:font-bold focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[var(--accent)]"
        >
              ...
              <ReactQueryProvider>
                ...
                <MainLayoutWrapper>
                  ...
                  <div id="main-scroll-container" className="flex-1 relative w-full z-[1] flex flex-col">
                    <main id="main-content" className="flex-1 flex flex-col relative z-[10] outline-none" tabIndex={-1}>
                      {children}
                    </main>
                    <Footer />
                  </div>
