...
export function getFlashcardsHtmlString(title: string, flashcards: any[]): string {
...
export function downloadFlashcardsOffline(title: string, flashcards: any[]) {
    triggerDownload(`Flashcards - ${escapeHtml(title)}.html`, getFlashcardsHtmlString(title, flashcards));
}

export function getQuizHtmlString(title: string, quizQuestions: any[], timerSeconds = 600): string {
    const safeTitle = escapeHtml(title);
...
export function downloadQuizOffline(title: string, quizQuestions: any[], timerSeconds = 600) {
    triggerDownload(`Quiz - ${escapeHtml(title)}.html`, getQuizHtmlString(title, quizQuestions, timerSeconds));
}

export function getSummaryHtmlString(title: string, renderedHtml: string): string {
    const safeTitle = escapeHtml(title);
...
export function downloadSummaryOffline(title: string, renderedHtml: string) {
    triggerDownload(`Summary - ${escapeHtml(title)}.html`, getSummaryHtmlString(title, renderedHtml));
}
