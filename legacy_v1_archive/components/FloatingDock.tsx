...
export const FloatingDock: React.FC<FloatingDockProps> = ({ mode, setMode, onHub, isDuelActive, onDuel }) => {
    ...
    return (
        <div className="fixed bottom-8 left-1/2 -translate-x-1/2 z-[90] hidden md:block">
            <div className="glass-container glass-container--rounded transition-all hover:scale-105">
                {/* Layer 0: Blur + Filter */}
                <div className="glass-filter" />
                {/* Layer 1: Tinted Overlay */}
                <div className="glass-overlay" />
                {/* Layer 2: Specular Highlights */}
                <div className="glass-specular" />
                {/* Layer 3: Content */}
                <div className="glass-content px-6 py-4 gap-4">
